...
import { BLUE_COLOR, PRIMARY_COLOR, YELLOW_COLOR } from '../../styles/color.global';
    ...
    return (
        <>
            ...
            <View style={tw`flex-1 items-center`}>
                ...
                <View style={[tw`w-full h-[40%] items-center`, { backgroundColor: 'rgb(45, 50, 80)' }]}>
                    <LottieView
                ...
                <ScrollView style={[StyleSheet.absoluteFill, tw`w-full flex-1 bg-white top-[38%] rounded-t-[24px]`]}>
                    <View style={tw`w-full my-[10px] flex items-center`}>
                        <Text style={[tw`text-[2rem]`, styles.title]}>Đăng nhập</Text>
                    </View>
                    <View style={tw`px-[20px]`}>
                        ...
                        <View style={tw`w-full my-[10px]`}>
                            ...
                            <View style={tw`mt-[16px] items-end`}>
                                <Text onPress={handleToForgotPassword} style={[tw`font-bold`, { color: YELLOW_COLOR }]}>
                                    Quên mật khẩu
                                </Text>
                            </View>
                            <View style={tw`mt-[20px] mx-[30px]`}>
                                <Button type="primary" title="Đăng nhập" onPress={handleSubmit(onSubmit)} />
                            </View>
                            ...
                            <View style={tw`mt-[10px] pb-[10px] flex-row justify-center items-center`}>
                                ...
                                <Text onPress={handleToRegister} style={[tw`font-bold`, { color: `${YELLOW_COLOR}` }]}>Đăng ký</Text>
                            </View>
                        </View>
                    </View>
                </ScrollView>
